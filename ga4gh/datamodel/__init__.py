    ...
    def __init__(self, parentCompoundId, *localIds):
        ...
        if parentCompoundId is not None:
            for field in parentCompoundId.fields:
                ...
                index += 1
        print (type(self), "fields", self.fields, self.containerIds, [x for x in dir(self) if x[0] != "_"])
